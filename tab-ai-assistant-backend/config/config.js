// config/config.js - Updated for Pinecone Serverless
...
module.exports = {
  ...
  pinecone: {
    ...
    // For serverless indexes, you don't need to specify environment
    // Instead you use region:
    region: process.env.PINECONE_REGION || 'us-east-1', // Default to us-west-2 if not specified
